      ...
      <div className={about}>
        <span>
          <span className={span_text}>
            NGC Ventures invests in early stage, web 3.0 infrastructure startups
            and projects. We identify <br /> projects with innovative ideas to
            today’s blockchain problems and work with them from ideation
          ...
          <br />
          affordability, speed, uniqueness and a compelling product market fit.
          <br />‍<br />
          ...
          London, Shanghai and Taipei. Our LPs include listed entities from web
          2.0, family offices, HNWI as well as founders who were our investees.
          <br />‍<br />
          ...
          the web3 and crypto space reflects our belief in the potential of this
          new era of the internet to bring about a wave of creativity and
          entrepreneurship.
          <br />
          <br />
          <strong>Funding Research</strong>
          <br />
          Many of tomorrow’s web 3.0 projects emerge out of today’s research. As
          such we invest heavily via grants, donations or investments into
          research teams at institutions of higher learning including: National
          University of Singapore, Nanyang Technology University, and UC
          Berkeley.
          <br />‍<br />
          ...
          with a much greater reach in terms of resources and connections in the
          space. Our investments include funds like Griffin Gaming Fund,
          Bitkraft, Republic Capital, Metaversal, Figment Capital,
          Collab+Currency, Symbolic Capital, WWG Ventures, Dispersion Capital,
          Geekcartel, Impossible Finance, 6th Man Ventures, Blockchain Founders
          Fund, Sanctor Capital, Shima Capital, Finenace Ventures, Borderless
          Capital, Bonfire Union and Longhash Ventures.
        </span>
      </div>
    </div>
  );
