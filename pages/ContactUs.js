      ...
      <div className={contact_container}>
        <div className={content}>
          ...
          <div className={paragragh}>
            <p>
              If you are engaged in trading related to the following themes, we
              encourage you to reach out to us at info@eqcap.fund. For any
              general inquiries, please feel free
              <br /> to contact us via,+254742740432,
              <span>
            ...
            <p>
              Our investment philosophy centers around the core infrastructure
              of the blockchain, with a particular focus on initiatives that
              enhance and facilitate crypto trading.
            </p>
          </div>
...
ContactUs.getLayout = function getLayout(page) {
  return (
    <HomeLayout showFooter={true} pageTitle={"Eqam capital | Contacts"}>
      {page}
    </HomeLayout>
  );
};
